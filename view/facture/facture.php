                  ...
                  <div class="col-lg-12">
                      <SECTION class="panel">
                          <HEADER class="panel-heading">
                           Formulaire de saisie des factures 
                         </HEADER>
                             ...
                             <form id="frm-alumno" action="?c=facture&a=Enregistrer" method="post" enctype="multipart/form-data">
                               <input type="hidden" name="Id" value="<?php echo $facture->Id; ?>" />
                                <div class="form-group">
                                    <label>CIN</label>
                                    <input type="text" name="CIN" value="" class="form-control" placeholder="CIN du facture" required>
                                </div>
                                <div class="form-group">
                                    <label>NOM</label>
                                    <input type="text" name="Nom" value="" class="form-control" placeholder="Nom du facture" required>
                                </div>
                                
                                <div class="form-group">
                                    <label>Telephone</label>
                                    <input type="text" name="Tel" value="" class="form-control" placeholder="N° Telephone du facture" required>
                                </div>
                                
                                <div class="form-group">
                                    <label>Village</label>
                                    <input type="text" name="IdVillage" value="" class="form-control" placeholder="Village du facture" required>
                                </div>    
...
<table class="table  table-striped  table-hover" id="tabla">
    ...
    <?php foreach($this->model->Lister() as $r): ?>
        <tr>
            ...
            <td>
                <a  class="btn btn-warning" href="?c=facture&a=Crud&Id=<?php echo $r->Id; ?>">Modifier</a>
            </td>
            <td>
                <a  class="btn btn-danger" onclick="javascript:return confirm('Voulez vous supprimer cet enregistrement?');" href="?c=facture&a=Supprimer&Id=<?php echo $r->Id; ?>">Supprimer</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
